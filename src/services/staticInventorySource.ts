...
// Loads inventory from static Excel files in /public/.
// This is the demo/internal-pilot data source.
// Files are publicly accessible — not suitable for sensitive data without auth.

import * as XLSX from "xlsx";
import { InventoryRow, DealerSource } from "../types";
import { InventoryService } from "./inventoryService";

const INVENTORY_PATHS: Record<DealerSource, string> = {
...
export const staticInventoryService: InventoryService = {
